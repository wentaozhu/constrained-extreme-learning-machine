function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = CELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
...
while i < NumberofHiddenNeurons + 1 
    ...
    if i < NumberofHiddenNeurons / 2 + 1
