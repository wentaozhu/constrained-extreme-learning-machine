function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = CSELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
