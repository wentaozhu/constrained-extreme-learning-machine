function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = DELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,C)
